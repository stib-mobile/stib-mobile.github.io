                ...
                <div class="androi" style="margin-bottom: 60px">
                    <div class="wrapper-link-android">
                        <a href="https://exp-shell-app-assets.s3.us-west-1.amazonaws.com/android/%40stiblabs2019/stib-p2p-5fd62ca8db994bddb5a4f848e0905a10-signed.apk">
                            <img class="btn-android" width="200" height="auto" src="images/background/apk-androi.png">
                            <img class="btn-android-hover" width="200" height="auto" src="images/background/apk-androi-hover.png">
                        </a>
                    ...
                    <div class="wrapper-link-ios" style="position: relative;">
                        <a href="https://exp-shell-app-assets.s3.us-west-1.amazonaws.com/ios/%40stiblabs2019/stib-p2p-581382fa-7eca-41f5-abf3-98e1eabe3f33-archive.ipa">
                            <img class="btn-ios" width="200" height="auto" src="images/background/apk-ios.png">
                            <img class="btn-ios-hover" width="200" height="auto" src="images/background/apk-ios-hover.png">
                        </a>
                        <div class="wrapper btn-video">
                            <button type="button" class="video-btn rounded-circle" data-toggle="modal"
                                data-target="#modelId">
                                ...
                                <div class="modal-body">
                                    <div class="wrapper-video-tut">
                                        <iframe id="source-video" width="310" height="676"
                                            src="https://www.youtube.com/embed/33-3rpzB29s?playlist=33-3rpzB29s&controls=0&mute=1&autoplay=1&loop=1"
                                            frameborder="0"
        ...
        <div class="app_photo col-lg-6 col-md-6 col-12">
            ...
            <div class="wrapper-animation-banner">
                <div class="background-animation">
                    ...
                    <img id="iphone-mockup-img" src="images/background/iphone-mockup.png" style="width:270px; height: auto;" />
                </div>
    ...
    <div class="container">
        <div class="page1 row align-items-center justify-content-center" id="page1">
            <div class="title col-lg-6 col-md-12">
                ...
                <ul>
                    <li>
                        <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 1:</span> ` + db[4].step[2] + `</span>
  
                        <span class="check-icon"><i class="fas fa-check"></i></span>
                    </li>
                    <li>
                        <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 2:</span>` + db[4].step[3] + `</span>
  
                        <span class="check-icon"><i class="fas fa-check"></i></span>
                    </li>
                    <li>
                        <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 3:</span>` + db[4].step[4] + `</span>
                        <span class="check-icon"><i class="fas fa-check"></i></span>
                    </li>
                    ...
                    <div class="modal-dialog d-flex align-items-center">
                        <div class="modal-content">
                            <div class="modal-body">
                                <div class="wrapper-video-tut">
                                    <iframe id="source-video" width="310" height="676"
                                        src="https://www.youtube.com/embed/39i75VxFFh0?playlist=39i75VxFFh0&controls=0&mute=1&autoplay=1&loop=1"
                                        frameborder="0"
                                        allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                        allowfullscreen></iframe>
                                </div>
            ...
            <div class="page2 row d-flex flex-row justify-content-center align-items-center" id="page2">
                        ...
                        <div class="modal-dialog d-flex align-items-center">
                            <div class="modal-content">
                                <div class="modal-body">
                                    <div class="wrapper-video-tut">
                                        <iframe id="source-video" width="310" height="676"
                                            src="https://www.youtube.com/embed/9uH_2BiTBIo?playlist=9uH_2BiTBIo&controls=0&mute=1&autoplay=1&loop=1"
                                            frameborder="0"
                                            allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                            allowfullscreen></iframe>
                                    </div>
                ...
                <div class="title col-lg-6 col-md-12 text-left">
                    ...
                    <ul>
                        <li>
                            <span class="check-icon"><i class="fas fa-check"></i></span>
                            <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 1:</span>` + db[4].step[6] + `</span>
                        </li>
                        <li>
                            <span class="check-icon"><i class="fas fa-check"></i></span>
                            <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 2:</span> ` + db[4].step[7] + `</span>
  
                        </li>
                        <li>
                            <span class="check-icon"><i class="fas fa-check"></i></span>
                            <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 3:</span>` + db[4].step[8] + `</span>
  
                        </li>
                        <li>
                            <span class="check-icon"><i class="fas fa-check"></i></span>
                            <span class="text-page"><span style="font-weight: bold;">`+ db[4].step[1] + ` 4:</span>` + db[4].step[9] + `</span>
